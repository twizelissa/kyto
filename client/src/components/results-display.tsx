      ...
      {isApplicationMethodResult ? (
        ...
        <>
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-black mb-6">以下の内容に沿ってお手続きください</h2>
          </div>
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        ...
                        <tr className="border-b">
                          <td className="px-3 py-4 font-bold bg-gray-50 align-top" style={{width: 'min(25%, 180px)'}}>
                            A欄<br/>
                  ...
                  <div className="bg-white border rounded-lg overflow-hidden">
                    <table className="w-full text-sm">
                      <tbody>
                        ...
                        <tr className="border-b">
                          <td className="px-3 py-4 font-bold bg-gray-50 align-top" style={{width: '25%', maxWidth: '180px'}}>
                            A欄<br/>
                            <span className="text-xs font-normal text-gray-600">顔写真付きの公的機関が発行した書類</span>
                          </td>
                          <td className="px-3 py-4" style={{width: '75%'}}>
                        ...
                        <tr>
                          <td className="px-3 py-4 font-bold bg-gray-50 align-top" style={{width: '25%', maxWidth: '180px'}}>B欄</td>
                          <td className="px-3 py-4" style={{width: '75%'}}>
                            <div className="text-xs leading-relaxed text-justify">
