                  ...
                  <div className="bg-white border rounded-lg overflow-hidden">
                    <table className="w-full text-sm">
                      <tbody>
                        ...
                        <tr className="border-b">
                          <td className="px-3 py-4 font-bold bg-gray-50 align-top" style={{width: '25%', maxWidth: '160px'}}>
                            A欄<br/>
                            <span className="text-xs font-normal text-gray-600">顔写真付きの公的機関が発行した書類</span>
                          </td>
                        ...
                        <tr>
                          <td className="px-3 py-4 font-bold bg-gray-50 align-top" style={{width: '25%', maxWidth: '160px'}}>B欄</td>
                          <td className="px-3 py-4" style={{width: '75%'}}>
                            <div className="text-xs leading-relaxed text-justify">
