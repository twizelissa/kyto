                ...
                <div className="mt-6">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <div className="space-y-3 text-sm text-gray-800 leading-relaxed">
                      ...
                      <p className="text-red-600 mt-3">※転入届又は転居届の手続きを行うに当たり、後日に同一世帯員の方が電子証明書の発行等の手続きを行う場合、又は同一世帯員以外の方に手続きを委任する場合は、照会書兼回答書が必要となりますので、マイナンバーカードセンターにお問合せください（電話：075－746－6855）。
