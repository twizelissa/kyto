          ...
          <div className="text-center mb-8">
            ...
            {answers.procedure === "info_change" && (
              <div className="mt-2 space-y-1 text-left">
                ...
                <p className="text-sm text-red-600">※ご本人が届出と併せて代理で同一世帯員の方のマイナンバーカードの電子証明書の発行等を行う場合は<span className="underline">こちら</span>をご確認ください。</p>
                <p className="text-sm text-red-600">※引越しの場合は<span className="underline">こちら</span>もご覧ください。</p>
              </div>
            )}
          </div>
