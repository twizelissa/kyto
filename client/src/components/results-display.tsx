            ...
            <CardContent className="p-2 sm:p-6">
              ...
              <div className="space-y-4 text-sm text-gray-800 leading-relaxed">
                ...
                <div className="space-y-2">
                  ...
                  <p>※　カードのお受取りの予約をされる場合は、交付通知書に記載の「製造管理番号」が必要となりますので、お手元にご用意ください。</p>
                  <p>※　カードのお受取りに関して、交付通知書の紛失等により「製造管理番号」が不明な際は、事前にマイナンバーカードセンターにお問い合わせいただき、ご確認ください。また、電話受付によるご予約をご希望の方は、「発送番号」も併せて事前にご確認ください。</p>
                </div>
              </div>
            </CardContent>
          </Card>
