          ...
          {question.id === "lost_procedures" ? (
            <>
              <div className="text-sm leading-relaxed space-y-4 mb-6">
                <p className="text-red-600">マイナンバーカードを紛失した時は，マイナンバーカード一時停止のお手続きが必要となります。必ず、一時停止のお手続きが完了してから再発行へ進んでください。<br />まだお済みでない方は、一度ホームへ戻り、「カードの紛失・紛失手続き後の発見」へ進み直してください。</p>
              </div>
