...
export const ITEMS: Record<string, RequiredItem> = {
  ...
  "cert_adult_guardian_cert": {name: "成年後見人に関する登記事項証明書原本", icon: "fas fa-file-certificate"},
  "cert_conservatee_cert": {name: "保佐人に関する登記事項証明書原本、代理行為目録", icon: "fas fa-file-certificate"},
  "cert_assisted_person_cert": {name: "補助人に関する登記事項証明書原本、代理行為目録", icon: "fas fa-file-certificate"},
  "cert_voluntary_guardian_cert": {name: "任意後見人に関する登記事項証明書原本、代理権目録", icon: "fas fa-file-certificate"}
};
